...
const Gallery = {
  ...
  DECOR: [
    ...
    // ====== NOVOS OBJETOS DE CENA INTERATIVOS (props.js) ======
    { type: 'chest',        name: 'Baú (tesouro)',          prop: true },
    { type: 'trapchest',    name: 'Baú armadilha',          prop: true },
    { type: 'mimic',        name: 'Mímico (baú monstro)',   prop: true },
    { type: 'mine',         name: 'Mina terrestre',         prop: true },
    { type: 'spikes',       name: 'Espinhos retráteis',     prop: true },
    { type: 'saw',          name: 'Serra deslizante',       prop: true },
    { type: 'flamevent',    name: 'Jato de chamas',         prop: true },
    { type: 'darttrap',     name: 'Armadilha de dardos',    prop: true },
    { type: 'pendulum',     name: 'Pêndulo (lâmina)',       prop: true },
    { type: 'gasvent',      name: 'Válvula de gás',         prop: true },
    { type: 'secretdoor',   name: 'Porta secreta',          prop: true },
    { type: 'lockeddoor',   name: 'Porta trancada (tiros)', prop: true },
    { type: 'cannon',       name: 'Canhão (inimigos)',      prop: true },
    { type: 'ballista',     name: 'Balista (inimigos)',     prop: true },
    { type: 'catapult',     name: 'Catapulta (inimigos)',   prop: true },
    { type: 'portal',       name: 'Portal (par)',           prop: true },
    { type: 'springpad',    name: 'Mola de salto',          prop: true },
    { type: 'updraft',      name: 'Corrente ascendente',    prop: true },
    { type: 'elevator',     name: 'Elevador',               prop: true },
    { type: 'bell',         name: 'Sino de alarme',         prop: true },
    { type: 'tripwire',     name: 'Fio de armadilha',       prop: true },
    { type: 'summon',       name: 'Círculo de invocação',   prop: true },
    { type: 'arcaneorb',    name: 'Orbe arcano',            prop: true },
    { type: 'shrine',       name: 'Santuário (cura)',       prop: true },
    { type: 'campfire',     name: 'Fogueira',               prop: true },
    { type: 'brazier',      name: 'Braseiro',               prop: true },
    { type: 'magicfire',    name: 'Fogo mágico',            prop: true },
    { type: 'chandelier',   name: 'Lustre',                 prop: true },
    { type: 'mushroom',     name: 'Cogumelos luminosos',    prop: true },
    { type: 'crystalcluster', name: 'Cristais',             prop: true },
    { type: 'fountain',     name: 'Fonte',                  prop: true },
    { type: 'statue',       name: 'Estátua',                prop: true },
    { type: 'grave',        name: 'Lápide',                 prop: true },
    { type: 'anvil',        name: 'Bigorna',                prop: true },
    { type: 'stalagmite',   name: 'Estalagmite',            prop: true },
  ],
  BIOMES: [
